import "./style.css";
import { getWeatherData, getNextSevenDays } from "./fetchData";
import { 
    weatherAddress,
    searchBtn
 } from "./query";
import { displayCurrentTemp, createNextSevenDays } from "./renderHtml";
...
async function search(searchInput){
    ...
    const futureData = await getNextSevenDays(searchInput);
    updateHtml(data);
    createNextSevenDays(futureData);
}
